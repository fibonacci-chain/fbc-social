...
fbchaincli keys add --recover admin16 -m "palace cube bitter light woman side pave cereal donor bronze twice work" -y --algo="" --coin-type 118
...
fbchaind add-genesis-account $(fbchaincli keys show $KEY    -a) 100000000fibo --home $HOME_SERVER
fbchaind add-genesis-account $(fbchaincli keys show admin16 -a) 900000000fibo --home $HOME_SERVER
fbchaind add-genesis-account $(fbchaincli keys show admin17 -a) 900000000fibo --home $HOME_SERVER
fbchaind add-genesis-account $(fbchaincli keys show admin18 -a) 900000000fibo --home $HOME_SERVER
