...
INIT="{\"verifier\":\"$(fbchaincli keys show captain | jq -r '.eth_address')\", \"beneficiary\":\"$(fbchaincli keys show fred | jq -r '.eth_address')\"}"
...
DEST_ACCOUNT=$(fbchaincli keys show fred | jq -r '.eth_address')
