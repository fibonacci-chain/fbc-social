...
import (
	...
	authtypes "github.com/fibonacci-chain/fbc-social/libs/cosmos-sdk/x/auth/exported"
	...
	tmprototypes "github.com/fibonacci-chain/fbc-social/libs/tendermint/proto/types"
	tmtypes "github.com/fibonacci-chain/fbc-social/libs/tendermint/types"
	tmprotoversion "github.com/fibonacci-chain/fbc-social/libs/tendermint/version"
	tmversion "github.com/fibonacci-chain/fbc-social/libs/tendermint/version"
	...
	okcapptypes "github.com/fibonacci-chain/fbc-social/app/types"
...
func NewTestChain(t *testing.T, coord *Coordinator, chainID string) TestChainI {
	...
	//balance = sdk.NewCoins(fbchaintypes.NewPhotonCoin(amount))
