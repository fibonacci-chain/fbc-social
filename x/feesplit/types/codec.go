...
const (
	// Amino names
	registerFeeSplitName = "fbchain/MsgRegisterFeeSplit"
	updateFeeSplitName   = "fbchain/MsgUpdateFeeSplit"
	cancelFeeSplitName   = "fbchain/MsgCancelFeeSplit"
	sharesProposalName   = "fbchain/feesplit/SharesProposal"
)
