...
func TestConvertDepositMsg(t *testing.T) {
	...
	testcases := []struct {
		...
		{
			msgstr: fmt.Sprintf("{\"delegator_address\": \"%s\",\"quantity\": {\"denom\": \"fibo\",\"amount\": \"1000\"}}", addr.String()),
		...
		{
			msgstr: `{"delegator_address": "0xB2910E22Bb23D129C02d122B77B462ceB0E89Db9","quantity": {"denom": "fibo","amount": "1000"}}`,
		...
		{
			msgstr: `{"delegator_address": "B2910E22Bb23D129C02d122B77B462ceB0E89Db9","quantity": {"denom": "fibo","amount": "1000"}}`,
		...
		{
			msgstr: `{"delegator_address": "B2910E22Bb23D129C02d122B77B462ceB0E89Db9","quantity": {"denom": "fibo","amount": "1.5"}}`,
		...
		{
			msgstr: `{"delegator_address": "B2910E22Bb23D129C02d122B77B462ceB0E89Db9","quantity": {"denom": "fibo","amount": "0.5"}}`,
		...
		{
			msgstr: fmt.Sprintf("{\"delegator_address\": \"\",\"quantity\": {\"denom\": \"fibo\",\"amount\": \"0.5\"}}"),
			fnCheck: func(msg sdk.Msg, err error, res types.MsgDeposit) {
				require.Error(t, err)
				require.Nil(t, msg)
			},
		...
		{
			msgstr: fmt.Sprintf("{\"delegator_address\": \"889Fb79ac5Ec9C1Ee86Db2D3f3857Dd3D4af0C2E\",\"quantity\": {\"denom\": \"fibo\",\"amount\": \"0.5\"}}"),
			res:    NewMsgDeposit(testMustAccAddressFromBech32("B2910E22Bb23D129C02d122B77B462ceB0E89Db9"), newTestSysCoin(5, 1)),
			fnCheck: func(msg sdk.Msg, err error, res types.MsgDeposit) {
