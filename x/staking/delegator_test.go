...
func TestDelegator(t *testing.T) {
	...
	actionsAndChecker := []actResChecker{
		...
		noErrorInHandlerResult(false),
		//  1. ValidDelegator1 delegate 8000 fibo, success
		noErrorInHandlerResult(true),
		//  2. ValidDelegator1 delegate 8000 fibo again, fail coz no balance
		noErrorInHandlerResult(false),
		noErrorInHandlerResult(false),
		...
		noErrorInHandlerResult(false),
		noErrorInHandlerResult(false),
		//   1. ValidDelegator1 UnBond 4000fibo, success
		noErrorInHandlerResult(true),
		//   2. ValidDelegator1 UnBond 4000fibo, success
		noErrorInHandlerResult(true),
		nil,
