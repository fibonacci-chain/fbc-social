...
import (
	...
	v018evm "github.com/fibonacci-chain/fbc-social/x/evm/legacy/v0_18"
	v018staking "github.com/fibonacci-chain/fbc-social/x/staking/legacy/v0_18"
...
func TestMigrate(t *testing.T) {
	...
	appState := genutil.AppMap{
		"staking": []byte(`{"params":{"bond_denom":"fibo","epoch":252,"max_bonded_validators":21,"max_validators_to_add_shares":30,"min_delegation":"0.000100000000000000","min_self_delegation":"10000.000000000000000000","unbonding_time":"1209600000000000"}}`),
		"evm":     []byte(`{"params":{"enable_call":true,"enable_create":true,"evm_denom":"fibo","extra_eips":null}}`),
	}
