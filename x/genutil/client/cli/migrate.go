...
import (
	...
	v018 "github.com/fibonacci-chain/fbc-social/x/genutil/client/legacy/v0_18"
)
...
Example:
$ %s migrate v0.11 /path/to/genesis.json --chain-id=fbc --genesis-time=2019-04-22T17:00:00Z
`, version.ServerName),
