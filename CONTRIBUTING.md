...
Thank you for considering making contributions to fbchain and related
repositories!
...
1. Either [open](https://github.com/fibonacci-chain/fbc-social/issues/new/choose) or
   [find](https://github.com/fibonacci-chain/fbc-social/issues) an issue you'd like to help with
...
3. If you would like to contribute:
   ...
   4. Follow standard Github best practices: fork the repo, branch from the
      ...
      - For core developers working within the fbchain repo, to ensure a clear
...
Take a peek at our [coding repo](https://github.com/fibonacci-chain/coding) for
...
Other notes:
  - Looking for a good place to start contributing? How about checking out some
    [good first issues](https://github.com/fibonacci-chain/fbc-social/issues?q=is%3Aopen+is%3Aissue+label%3A%22good+first+issue%22)
...
While my fork lives at `https://github.com/rigeyrigerige/fbchain`,
the code should never exist at  `$GOPATH/src/github.com/rigeyrigerige/fbchain`.
Instead, we use `git remote` to add the fork as a new remote for the original repo,
`$GOPATH/src/github.com/okex/fbchain `, and do all the work there.

For instance, to create a fork and work on a branch of it, I would:

  - Create the fork on github, using the fork button.
  - Go to the original repo checked out locally (i.e. `$GOPATH/src/github.com/okex/fbchain`)
  - `git remote rename origin upstream`
  - `git remote add origin git@github.com:rigeyrigerige/fbchain.git`

Now `origin` refers to my fork and `upstream` refers to the fbchain version.
So I can `git push -u origin master` to update my fork, and make pull requests to fbchain from there.
...
### Development Procedure
  ...
  - create a development branch either on github.com/okex/fbchain, or your fork (using `git remote add origin`)
